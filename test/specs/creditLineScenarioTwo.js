...
describe('SCENARIO ONE CREATE CREDIT LINE AND TRACKING TRANSACTIONS', () => {
  ...
  it('should validate that field Credit Available($500.00) equals Principal Balance in transaction table', function () {
  ...
  it('should validate that field Credit Available($300.00) equals Principal Balance in transaction table', function () {
    expect(LineOfCreditPage.creditAvailable.getText()).contains(
